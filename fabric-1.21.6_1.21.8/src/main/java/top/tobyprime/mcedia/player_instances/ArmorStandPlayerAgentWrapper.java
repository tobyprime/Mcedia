    ...
    public void update() {
        try {
            ...
            playerAgent.rotation = new Quaternionf()
                    ...
                    .rotateXYZ((float) Math.toRadians(-entity.getHeadPose().x()), (float) Math.toRadians(-entity.getHeadPose().y()), (float) Math.toRadians(-entity.getHeadPose().z()));
        ...
        var volumeFactor = 1 - rotationToFactor(entity.getLeftArmPose().x());
        var speedFactor = rotationToFactor(entity.getRightArmPose().y());
        if (speedFactor < 0.1) {
            speed = 1;
