...
public class VideoTexture extends AbstractTexture {
    ...
    public void resize(int width, int height) {
        ...
        this.texture = gpuDevice.createTexture(this.id::toString, usage, TextureFormat.RGBA8, width, height, 1, 1);
    ...
    public void uploadData(ByteBuffer buffer){
        ...
        GpuDevice gpuDevice = RenderSystem.getDevice();
        gpuDevice.createCommandEncoder().writeToTexture(texture, buffer.asIntBuffer(), NativeImage.Format.RGBA, 0, 0,0,0, this.texture.getWidth(0), this.texture.getHeight(0));
    }
