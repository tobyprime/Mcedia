...
public class PlayerRenderer {
    ...
    public void render(ArmorStandRenderState state, MultiBufferSource bufferSource, PoseStack poseStack, int i, PlayerAgent agent) {
        ...
        var leftArmPoseX = state.leftArmPose.getX();
        var leftArmPoseY = state.leftArmPose.getY();
        ...
        try {
            ...
            poseStack.mulPose(new Quaternionf().rotationYXZ(
                    (float) Math.toRadians(-state.headPose.getX()),
                    (float) Math.toRadians(-state.headPose.getY()),
                    (float) Math.toRadians(-state.headPose.getZ())
            ));
