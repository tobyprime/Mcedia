...
public class MediaPlayerAgentEntity extends Entity {
    ...
    public static final EntityType<MediaPlayerAgentEntity> TYPE = Registry.register(
            ...
            Identifier.fromNamespaceAndPath("mcedia", "player_agent"),
            EntityType.Builder.of(MediaPlayerAgentEntity::new, MobCategory.MISC).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("mcedia", "player_agent")))
    );
    ...
    public VideoTexture texture = new VideoTexture(Identifier.fromNamespaceAndPath("mcedia", "player_agent" + this.stringUUID));
